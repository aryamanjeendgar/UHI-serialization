...
__all__ = ["write_hdf5_schema", "read_hdf5_schema"]
...
STORAGE_TYPES: dict[str, bh.storage.Storage] = {
...
def write_hdf5_schema(file_name: str, histograms: dict[str, bh.Histogram]) -> h5py.File:
